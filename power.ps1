...
$smtp.Credentials = New-Object System.Net.NetworkCredential("email here @outlook.com", "kishoorkannan579@gmail.com kishoorcool579");
$smtp.EnableSsl = $true
$Message.From = "senders email address same as above"
$Message.To.Add("kishoorkannan579@gmail.com")
